...
SDK_BASE	?= C:\Stream\ESP\SDK\2.0.0
SDK_LIBDIR  = lib
SDK_INCDIR  = include

ESPTOOL      ?= "C:\Python27\python.exe" "C:\Users\Gurov.Ilya\Source\Repos\ESP\SDK\esptool-py\esptool.py"
...
all: $(BUILD_DIR) $(FW_DIR) $(FW_DIR)/rom0.bin
...
flash: $(FW_DIR)/rom0.bin $(FW_DIR)/sdk.bin bin/rboot.bin bin/conf.bin
	...
	"C:\WinApps\Putty\Putty.exe" -load "COM2 115200"
